...
const input = Object.keys(input_map).map(ingredient => {
    ...
    // Adds name for completeness / logging purposes sake
...
for (amounts_range of G.combination(ingredients, (NUMBER_OF_INGREDIENTS - 1))) {
    ...
    // I originally had a bug where my ingredient breakdown totaled more than 100, this is just to help with that
