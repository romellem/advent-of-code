...
let test_best_bridge = test_bridges.getLongestAndHighestScoringBridge();

assert.strictEqual(Bridges.getSolutionScore(test_best_bridge), 19);

let bridges = new Bridges(input);
let best_bridge = bridges.getLongestAndHighestScoringBridge();
